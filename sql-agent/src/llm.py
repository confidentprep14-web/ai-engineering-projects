...
call os.environ.get() on the API key secrets — agent.py never touches them
directly, it just calls get_completion(). Unit tests mock get_completion
directly; it is never mocked in the main CLI code path.
"""
