"""FastAPI app: /health, /chat (SSE streaming), /stats.
...
Identical to p1-08-streaming-chat-api; this project packages it into a
Docker container rather than changing the application logic.
"""
import time
import uuid
