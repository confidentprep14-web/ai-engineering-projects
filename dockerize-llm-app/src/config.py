...
The one change from p1-08: DATABASE_PATH defaults to /data/chat_requests.db
instead of ./chat_requests.db. /data/ is the Docker named volume mount point
(see docker-compose.yml) — anything written outside it is lost when the
...
class Config:
    ...
    database_path: str = os.getenv("DATABASE_PATH", "/data/chat_requests.db")
