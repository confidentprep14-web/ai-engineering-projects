...
routes to Anthropic, OpenAI, or Ollama. Not used anywhere in the search
pipeline today — included for a future LLM-assisted reranking extension,
following the same plain-text interface as pr-diff-summarizer's llm.py
(no JSON-mode wrapping).
"""
