...
A fixed-window limiter lets a client burst 2x the limit at the window
boundary. The sliding window avoids that by tracking individual request
timestamps and discarding the ones older than 60 seconds on every check.
