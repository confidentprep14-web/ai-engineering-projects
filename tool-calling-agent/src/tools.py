...
to the agent loop. call_tool() never raises — every failure mode becomes a
string the LLM can read and react to.
"""
...
WIKIPEDIA_USER_AGENT = "p1-06-tool-calling-agent/1.0 (https://github.com/; educational project)"
...
def call_tool(tool_name: str, arguments: dict) -> str:
    ...
    error strings, so the agent loop can keep going instead of crashing.
    """
